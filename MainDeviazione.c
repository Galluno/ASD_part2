...
int main()
{
    ...
    scanf("%d", &scelta);
        ...
        n = 1000;          //DETERMINO IL NUMERO DI OPERAZIONI DA ESEGURE IN UN ITERAZIONE DEL FOR PIU ESTERNO
        ...
        for (int w = 0; w < measurePrec; w++)
        {
            ...
            vector[w] = (((tempo / k)- destroyTime[24]) / n); //TEMPO MEDIO E AMMORTIZZATO PER L'ESECUZIONE DI n OPERAZIONI
                                                            //NOTA CAMBIA 24 NELL INDICE j CHE TI DA 10000
        ...
        printf("la deviazione standard è: %lf\n", D); //stampa a video la combinata della lunghezza della stringa e del tempo impiegato a processarla
